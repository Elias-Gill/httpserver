...
public class App {
    public static void main(String[] args) {
        ...
        HttpServer server = new HttpServer.Builder().withPort(8080).withMaxConnections(20).build();
    ...
    private static class home extends HttpRoute {
        ...
        public void GET(HttpRequest req, HttpResponse resp) {
            resp.withStatus(200).withBody(req.getBody()).send();
        }
        ...
        public void POST(HttpRequest req, HttpResponse resp) {
            ...
            resp.withStatus(200).withBody("{\"nombre\":\"elias sebastian gill\"}").send();
        }
    }
}
